...
export const ToolFallback: ToolCallMessagePartComponent = ({
  ...
  // Ensure toolName is a string - handle both string and object cases
  const displayToolName = typeof toolName === 'string' 
    ? toolName 
    : (toolName as any)?.name || JSON.stringify(toolName);
